  ...
  return (
    <div className="flex-1 w-full h-full p-1.5 sm:w-1/4 flex flex-row gap-2 items-center">
      <Card className="flex-1 h-full bg-primary/10 w-full py-1.5 p-3 sm:p-3">
        <CardContent className="flex flex-row sm:flex-col items-center h-full justify-between gap-1 sm:gap-2 text-center p-0">
          <div className="flex-1 flex gap-4 items-center sm:flex-col sm:gap-1">
            {index &&
