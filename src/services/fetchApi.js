...
export async function fetchAssignments(headers) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/assignments`,
    { headers },
  );
  let data;
  try {
  ...
  if (!response.ok)
    handleApiError(response, data, "Could not fetch assignments");
  return data;
}

export async function fetchSubmissions(assignment_id, headers) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/assignments/${assignment_id}/submissions`,
    { headers },
  );
  let data;
  try {
  ...
  if (!response.ok)
    handleApiError(response, data, "Could not fetch submissions");
  return data;
}

export async function fetchUser(headers) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/users/me`,
    { headers },
  );
  let data;
  try {
...
export async function uploadSubmissions(assignment_id, encoded_files, headers) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/assignments/${assignment_id}/submissions/upload`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function deleteAssignment(assignment_id, headers) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/assignments/${assignment_id}`,
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
  ...
  if (!response.ok)
    handleApiError(response, data, "Could not delete assignment");
  return data;
}

export async function generateRubrics(payload, headers) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/rubrics/generate`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function getSubmissionFileURL(submission_id, headers) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/submissions/${submission_id}/file`,
    { headers },
  );
  let data;
  try {
  ...
  if (!response.ok)
    handleApiError(response, data, "Could not fetch submission file");
  return data;
}

export async function gradeSubmissions(assignment_id, payload, headers) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/assignments/${assignment_id}/submissions/grade`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  if (!response.ok)
    handleApiError(response, data, "Could not grade submissions");
  return data;
}
...
export async function deleteSubmissions(
  ...
  if (!response.ok)
    handleApiError(response, data, "Could not delete submissions");
  return data;
}

export async function confirmSubmissionGrades(
  assignment_id,
  submission_ids,
  headers,
) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/assignments/${assignment_id}/submissions/confirm-grades`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  if (!response.ok)
    handleApiError(response, data, "Could not confirm submissions");
  return data;
}
...
export async function updateSubmission(
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_FASTAPI_URL}/submissions/${submission_id}`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
